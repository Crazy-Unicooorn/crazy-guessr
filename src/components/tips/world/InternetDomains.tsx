...
function InternetDomains() {
  const InternetDomain: Card[] = [
    ...
    { front: ".es", back: "Spain" },
    { front: ".eu", back: "European Union member states" },
    ...
    { front: ".ලංකා", back: "Sri Lanka" },
    { front: ".இலங்கை", back: "Sri Lanka" },
    ...
    { front: ".срб", back: "Serbia" },
    { front: ".ru", back: "Russia" },
    { front: ".рф", back: "Russia" },
